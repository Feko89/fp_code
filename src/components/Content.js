...
<p>Markdown je skvelý nástroj na rýchle písanie formátovaného textu, ktorý sa dá jednoducho konvertovať do rôznych formátov, ako HTML. Je jednoduchý, flexibilný a vhodný na písanie poznámok, dokumentácie alebo blogov.</p>
  ...
  <>
  <h1>Pre Študentov</h1>
<p>Kedže autori tejto stránky sú absolventi Strednej priemyselnej školy elektrotechnickej v Prešove, rozhodli sme sa podeliť o rady a tipy, ktoré vám pomôžu sa uplatniť a ešte viac zlepšovať v programovaní.</p>

<h2>Súťaže</h2>
<p>Radi by sme vám ukázali do ktorých súťaží sa na škole môžete zapojiť:</p>
...
<h4>Prečo súťažiť?</h4>
Súťaz zenit je veľmi seriózna a vážená to sa odráža aj na finančných odmenách ktoré ťa určite potešia. Podmienkou je skončiť v top 3 na školskom či krajskom kole.<br></br>
Ďalšia motivácia môže byť že práve táto súťaž ťa môže dostať na rôzne univerzity ako Brno či Bratislava.</p>
<h3>Coding Game</h3>
<p style={{ marginLeft: '5%' }}>Súťaž Coding Game je pre programátorov ktorí majú radi interaktívne rozhranie a radi by sa naučili nové spôsoby či algoritmy v programovaní. Stránka obsahuje mnoho postupov, návodov a vysvetliviek takže ak si len žačiatočník neváhaj a zapoj sa.<br></br><br></br>
<h4>Prečo súťažiť?</h4>
...
<h3>KSP</h3>
<p style={{ marginLeft: '5%' }}>Súťaž KSP je hlavne pre žiakov ktorí maju dosť voľného času. Je to taký beh na dlhú trať kedže trvá niekoľko mesiacov ale určite sa pri nej zabavíte a vyriešite veľa zaujímavých úloh. Autori tejto súťaže spolupracujú aj s autormi súťaže ZENIT takže pre vás môže byť príprava.<br></br><br></br>
<h4>Prečo súťažiť?</h4>
Najúspešnejší riešitelia dostanú pozvánku na programátorký tábor, kde sa veľa naučíš a stretneš ďalších mladých programátorov ako si ty. Ďalším benefitom môže byť finančná odmena za účasť od našej školy.
</p>
<h3>Advent od code</h3>
<p style={{ marginLeft: '5%' }}>Advent of code by sme ani nepovažovali ako súťaž sice sa môžeš porovnávať s ostnatnými žiakmi našej školy ale je to hlavne výzva. Čaká ťa maratón 24 úloh každý rok na Advent. Úlohy sú veľmi kreatívne a späté s vianočnou tématikou.<br></br>ako vyhrať?<br></br>Každé ráno počas adventu vstaň o 6:00 a urob úlohu čo najrýchlejšie.<br></br><br></br>
<h4>Prečo súťažiť?</h4>
...
<h3>KSI</h3>
<p style={{ marginLeft: '5%' }}>Korešpondencný seminár z informatiky na našej škole nieje veľmi rozšírený teda za našich čias. Organizuje ho Masarykova Univerzita v Brne. Ponúka veľa úloh ktorých hlavnou úlohou je ťa naučiť programovať. Mali by ho zvládnuť aj žiaci ktorí nemali s programovaním žiadnu skúsenosť no my si to nemyslíme.<br></br><br></br>
<h4>Prečo súťažiť?</h4>
Kedže ho organizuje Masarykova Univerzita, toto je práve cesta ako sa vyhnuť príjmačkám, ak tam chceš ísť študovať. Na našej škole žiadne ceny nečakaj, túto súťaž sme vám pridali iba my tvorcovia tejto stránky, pretože sme si mysleli že by sa vám vo štvrtom ročníku mohla hodiť.
</p>
